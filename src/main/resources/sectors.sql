...
-- This file automatically loads data on application startup
-- ===================================================================

-- Insert sectors with their original IDs from the HTML
...
-- Manufacturing subcategories (level 1)
INSERT INTO sectors (id, name, parent_id) VALUES
...
-- Plastic processing technology (level 3)
INSERT INTO sectors (id, name, parent_id) VALUES
(55, 'Blowing', 559),
(57, 'Moulding', 559),
...
-- IT and Telecommunications (level 2)
INSERT INTO sectors (id, name, parent_id) VALUES
...
-- Transport and Logistics (level 2)
INSERT INTO sectors (id, name, parent_id) VALUES
(111, 'Air', 21),
(114, 'Rail', 21),
(112, 'Road', 21),
